...
import { Home, Lock, Mail, User, Building, ShieldCheck } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex flex-col selection:bg-pink-200 selection:text-pink-900">
            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-md bg-white/10 backdrop-blur-2xl rounded-3xl p-8 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] border border-white/20 my-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-pink-200 mt-2 text-sm font-medium">Join your CommunityConnect today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="relative group">
                            <User className="absolute left-3 top-3 w-5 h-5 text-indigo-300 group-focus-within:text-pink-400 transition-colors" />
                            <input
                                type="text"
                                name="name"
                        ...
                        {formData.role === 'Resident' && (
                            <div className="relative group">
                                <Home className="absolute left-3 top-3 w-5 h-5 text-indigo-300 group-focus-within:text-pink-400 transition-colors" />
                                <input
                                    type="text"
